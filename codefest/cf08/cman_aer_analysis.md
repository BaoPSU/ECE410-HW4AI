...
**Visual (generated by `make_plots.py`):**

![Interface headroom bars](headroom_bars.png)
...
![Burst timing and FIFO fill](burst_timing.png)
...
![AER vs frame-based bandwidth crossover](crossover_plot.png)
