...
**Bao Nguyen | baon@pdx.edu | ECE 410/510 Spring 2026**
...
- Use the first real Quiz 2 attempt on the topics above after one drill session. Hold the second token in reserve.
- Memorial Day Mon May 25 = no lecture.
