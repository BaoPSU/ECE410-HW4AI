...
- **Vary wording naturally** — alternate "simultaneously" with "at the same time", alternate "nearby" with "adjacent" rather than always saying "neighboring", use "routes", "distributes", "delivers", or "sends" instead of "fans out", use "not viable", "unworkable", or "too expensive" instead of "infeasible". Small variation makes the answer sound more natural and less rehearsed.
